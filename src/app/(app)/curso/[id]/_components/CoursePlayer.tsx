  ...
  return (
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="mt-5 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            {selected.description && (
              <p className="mt-1.5 max-w-xl whitespace-pre-line text-[17px] leading-relaxed text-white/90">
                {selected.description}
              </p>
            )}
          </div>
          <button
            ...
            className={cn(
              ...
              isWatched
                ...
                : "border-white bg-white text-ancora-dark hover:bg-transparent hover:text-white",
            )}
          >
            {isWatched ? (
              <>
      ...
      <div className="lg:col-span-1">
        ...
        <h2 className="mb-3 text-[21px] font-bold text-white">
          Aulas
        </h2>
