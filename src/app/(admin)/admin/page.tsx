...
export default async function AdminDashboard() {
  ...
  return (
    <div>
      <h1 className="mb-6 text-[30px] font-extrabold text-tinta">
        Painel
      </h1>
      ...
      {aguardando > 0 && (
        ...
        >
          <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-ambar text-[19px] font-extrabold text-tinta">
            !
          </span>
          ...
          <span className="ml-auto hidden shrink-0 text-[16px] font-bold text-ancora sm:inline">
            Revisar →
          </span>
        </Link>
      )}
...
function DashCard({
  ...
  return (
    ...
    >
      <span
        className={`text-[41px] font-extrabold leading-none ${
